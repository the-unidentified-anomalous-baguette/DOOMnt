...
function mapDraw(){
  ...
  for (let i = -3; i < 4; i++){
    for (let j = -3; j < 4; j++){
      if (currentMap[playerCoords[0] + i][playerCoords[1] + j].floor == 1){
        fill(currentMap[playerCoords[0] + i][playerCoords[1] + j].floorC)
        rect(48 + 16 * j, 48 + 16 * i, 16, 16)
      }
      else if (currentMap[playerCoords[0] + i][playerCoords[1] + j].knee == 1){
        fill(currentMap[playerCoords[0] + i][playerCoords[1] + j].kneeC)
        rect(48 + 16 * j, 48 + 16 * i, 16, 16)
      }
      else if (currentMap[playerCoords[0] + i][playerCoords[1] + j].shoulder == 1){
        fill(currentMap[playerCoords[0] + i][playerCoords[1] + j].shoulderC)
        rect(48 + 16 * j, 48 + 16 * i, 16, 16)
      }
      else if (currentMap[playerCoords[0] + i][playerCoords[1] + j].head == 1){
        fill(currentMap[playerCoords[0] + i][playerCoords[1] + j].headC)
        rect(48 + 16 * j, 48 + 16 * i, 16, 16)
      }
      else if (currentMap[playerCoords[0] + i][playerCoords[1] + j].ceiling == 1){
        fill(currentMap[playerCoords[0] + i][playerCoords[1] + j].ceilingC)
        rect(48 + 16 * j, 48 + 16 * i, 16, 16)
      }
    }
  }
